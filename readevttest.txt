...
class KeyboardLogger:
    ...
    def start_logging(self):
        ...
        try:
            ...
            self.log_file.write(f"\n--- Keyboard logging started at {datetime.now()} ---\n")
            self.log_file.flush()
    ...
    def handle_key_press(self, key):
        ...
        try:
            ...
            if key in ['KEY_LEFTSHIFT', 'KEY_RIGHTSHIFT']:
                ...
                self.log_file.write(f'[SHIFT_PRESS]')
                self.log_file.flush()
                ...
                self.log_file.write(f'[NUMLOCK_{"ON" if self.num_lock else "OFF"}]')
                self.log_file.flush()
    ...
    def stop_logging(self):
        ...
        if self.log_file:
            self.log_file.write(f"\n--- Keyboard logging stopped at {datetime.now()} ---\n")
            self.log_file.close()
